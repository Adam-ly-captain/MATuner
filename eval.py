from environment.mysql_op import ConnNDB, clear_binlog, get_mysql_conn, close_conn
...
if __name__ == "__main__":
    ...
    data = pd.read_excel("./model/maddpg/res/eval_random_write_only.xlsx")
    ...
    for i in range(episode):
        state, action, reward, next_state, perf_start, perf_next = get_random_sample(
            noise_flag=False
        )
    ...
    data.to_excel("./model/maddpg/res/eval_random_write_only.xlsx", index=False)
